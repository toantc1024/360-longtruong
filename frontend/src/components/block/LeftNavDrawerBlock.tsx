...
export const LeftNavDrawerBlock: React.FC<LeftNavDrawerBlockProps> = ({
  ...
  // Detail view: show item detail inside the drawer
  if (selectedItem) {
    return (
            ...
            <div className="h-full w-full grow p-4 sm:p-5 flex flex-col rounded-[24px] glass-light text-white shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center gap-3 pb-3 border-b border-white/15">
                <button
                  ...
                  className="w-9 h-9 glass-hover bg-white/10 rounded-full flex items-center justify-center text-white cursor-pointer"
                >
                ...
                {selectedItem.hotspot_id && (
                  <div className="space-y-3">
                    ...
                    {selectedItem.description && (
                      <div
                        className="text-white/80 leading-relaxed bg-white/5 p-3 rounded-2xl border border-white/10"
              ...
              <div className="flex items-center justify-between pb-3 border-b border-white/15">
                <div className="flex items-center gap-3">
                  <Drawer.Close asChild>
                    <Button className="w-9 h-9 glass-hover bg-white/10 rounded-full p-2 text-white">
                      <FiArrowLeft className="size-5" />
                    </Button>
                  </Drawer.Close>
                  <div>
                ...
                {activeTab === "routes" && (
                  <>
                    {filteredRoutes.length === 0 ? (
                      <p className="text-xs text-white/40 text-center py-8">Chưa có tuyến đường tham quan nào.</p>
                    ) : (
